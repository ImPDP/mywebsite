...
const NavBar=()=>{
   ...
   return(
                ...
                <AnchorLink   href='#work' style={{color:'white',backgroundColor:'rgba(255,255,255,0)'}}  className="nav-item nav-link active">Works</AnchorLink>
                <AnchorLink   style={{color:'white',backgroundColor:'rgba(255,255,255,0)'}} href="#skills" className="nav-item nav-link">Skills</AnchorLink>
